        ...
        <>
            <div className="bg-white pt-6 pb-8 mb-4">
                { !isOtpSent ? (
                        ...
                        <div className="mb-2 formInnerBox">
                            <label className="block text-[#8D93A1] text-xs font-normal mb-3" htmlFor="username">
                                Use the same email address through which you applied for the GDG on Campus application process
                            </label>
                            <input 
                ...
                <div className="ifOtpSent">   
                    <p className="block text-[#8D93A1] text-sm font-normal mb-3">Enter the OTP sent on your registered email address</p>
                    ...
                    <div className="w-full flex justify-center md:justify-start text-xs text-gray p-2">
                        <div>Did not receive the OTP? <span className="text-google-blue" onClick={loginSubmit} >Resend</span></div>
                    </div>
