                        ...
                        {loading? (<CircularProgress/>) :(
                            ...
                            {moderators.length === 0 ?(
                                ...
                                <div className='w-full x-scroll py-4 px-2'>
                                    <Table download={download} tableHeaders={['#','Full Name', 'Email ID', 'Availability','Total Slots', 'Booked Slots', 'Available Slots (today onwards)', 'Conferences Today', 'Remove Moderator']} tableContent={moderators} eventName={event?.eventURL} tableName={'moderatorsByEventURL'} remove={removeModerator}/>
                                </div>
                            )}
                            </>
                        )}
